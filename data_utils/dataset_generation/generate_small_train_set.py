...
torch.save(subset_batch.poses.clone(), os.path.join('data', output_name + '_poses.pt'))
torch.save(subset_batch.labels.clone(), os.path.join('data', output_name + '_labels.pt'))
