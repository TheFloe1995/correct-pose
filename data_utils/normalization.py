...
class IndividualNormalizer(BaseNormalizer):
    ...
    def normalize_single(cls, poses):
        ...
        # vectors between the MSP and the palm joints. The x-axis direction equals the average
        # vector from MSP to IMCP, MMCP, RMCP and PMCP (in the previously defined plain).
